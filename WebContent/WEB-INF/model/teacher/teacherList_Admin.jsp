      			...
      			<c:choose>
					...
					<c:otherwise>
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="<%=path%>/teacher/listAdminTeacher?page=1"><span>首页</span></a>
								<a href="<%=path%>/teacher/listAdminTeacher?page=${pageBean.currentPage-1}"><span>上一页</span></a>
							</c:otherwise>
						</c:choose> <c:choose>
							<c:when test="${pageBean.currentPage != pageBean.totalPage}">
								<a href="<%=path%>/teacher/listAdminTeacher?page=${pageBean.currentPage+1}"><span>下一页</span></a>
								<a href="<%=path%>/teacher/listAdminTeacher?page=${pageBean.totalPage}"><span>尾页</span></a>
							</c:when>
							<c:otherwise>
								<a><span>下一页</span></a>
								<a><span>尾页</span></a>
