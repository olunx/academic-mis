...
<jsp:include page="/top.jsp"></jsp:include>
	...
	<div id="content" class="subcontainer fleft">
		<div class="breadcrumb"> <a href="<%=path%>/index">首页</a> &raquo; <a href="<%=path %>/subject/listMeSubject">我发布的科研课题</a> </div>
	<div class="post">
		<h2 class="mainhead">我发布的科研课题</h2>
		<c:choose>
		...
		<c:otherwise>
			...
			<div class="wp-pagenavi">
				...
				<c:choose>
					...
					<c:otherwise>
						<a class="page" href="<%=path%>/subject/listMeSubject?page=1">首页</a>
						<a class="page" href="<%=path%>/subject/listMeSubject?page=${pageBean.currentPage-1}">上一页</a>
					</c:otherwise>
				</c:choose>
				<c:choose>
					<c:when test="${pageBean.currentPage != pageBean.totalPage}">
						<a class="page" href="<%=path%>/subject/listMeSubject?page=${pageBean.currentPage+1}">下一页</a>
						<a class="last" href="<%=path%>/subject/listMeSubject?page=${pageBean.totalPage}">尾页</a>
					</c:when>
					<c:otherwise>
						<a class="page">下一页</a>
						<a class="last">尾页</a>
