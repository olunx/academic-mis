...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" background="<%=path %>/content/images/admin/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">添加助理</div></td>
      </tr>
    </table></td>
        ...
        <td width="100%" valign="top">
        	<div class="context">
      		<form action="<%=path %>/assistant/addAssistant" method="post">
	      		用户名：<input type="text" name="asDto.username" /><br/>
	      		密码：<input type="password" name="asDto.password" /> <br/>
	      		确认密码： <input type="password" name="asDto.rpassword" /> <br/>
	      		昵称：<input type="text" name="asDto.realName"> <br/>
