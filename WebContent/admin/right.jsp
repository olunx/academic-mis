    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="40%" valign="top"><table width="100%" height="144" border="0" cellpadding="0" cellspacing="0" class="line_table">
          <tr>
            <td width="7%" height="27" background="<%=path %>/content/images/admin/news-title-bg.gif"><img src="<%=path %>/content/images/admin/news-title-bg.gif" width="2" height="27"></td>
            <td width="93%" background="<%=path %>/content/images/admin/news-title-bg.gif" class="left_bt2">最新动态</td>
          </tr>
          <tr>
      ...
      <tr>
        <td colspan="2" valign="top">
          ...
          <TABLE class="main_tab" id="mainTable" cellSpacing="0" cellPadding="0" width="100%" border="0">
                ...
                <TBODY style="DISPLAY: block">
                  <TR>
                    <TD vAlign="top" align="center"><TABLE width="98%" height="133" border="0" align="center" cellPadding="0" cellSpacing="0">
                        <TBODY>
                          <TR>
                            <TD height="5" colspan="3"></TD>
                          </TR>
                          <TR>
                            <TD width="4%" height="28" background="<%=path %>/content/images/admin/news-title-bg.gif"></TD>
                            <TD height="25" colspan="2" background="<%=path %>/content/images/admin/news-title-bg.gif" class="left_txt"><font color="#FFFFFF" class="left_ts">亲爱的管理员： </font><b></b></TD>
                          </TR>
                          <TR>
                  ...
                  <TR>
                    <TD vAlign="top" align="center"><TABLE width=98% height="133" border="0" align="center" cellPadding="0" cellSpacing="0">
                        <TBODY>
                          ...
                          <TR>
                            <TD width="4%" height="28" background="<%=path %>/content/images/admin/news-title-bg.gif"></TD>
                            <TD colspan="2" background="<%=path %>/content/images/admin/news-title-bg.gif" class="left_txt">现有会员：名&nbsp;&nbsp; 其中：                                名&nbsp;&nbsp;&nbsp;&nbsp;名&nbsp;&nbsp;&nbsp;&nbsp;名</TD>
                          </TR>
                          <TR>
                            <TD bgcolor="#FAFBFC">&nbsp;</TD>
                  ...
                  <TR>
                    <TD vAlign="top" align="center"><TABLE width=98% border="0" align="center" cellPadding="0" cellSpacing="0">
                        <TBODY>
                          ...
                          <TR>
                            <TD width="4%" height="25" background="<%=path %>/content/images/admin/news-title-bg.gif"></TD>
                            <TD height="25" colspan="2" background="<%=path %>/content/images/admin/news-title-bg.gif" class="left_txt"><span class="TableRow2">服务器IP:</span>系统版本：</TD>
                          </TR>
                          <TR>
                          ...
                          <TR>
                            <TD height="25" bgcolor="#FAFBFC">&nbsp;</TD>
                            <TD height="25" bgcolor="#FAFBFC"><span class="left_txt">FSO文本读写：</span><span class="TableRow2"><font color="#FF0066"><b><img src="<%=path %>/content/images/admin/X.gif" width="12" height="13"></b></font><img src="<%=path %>/content/images/admin/g.gif" width="12" height="12"></span></TD>
                            <TD height="25" bgcolor="#FAFBFC"><span class="left_txt">数据库使用：</span><span class="left_ts"><img src="<%=path %>/content/images/admin/X.gif" width="12" height="13"><b style="color:blue">
                  ...
                  <TR>
                    <TD vAlign="top" align="center"><TABLE width="98%" border="0" align="center" cellPadding="0" cellSpacing="0">
                        <TBODY>
                          ...
                          <TR>
                            <TD width="4%" background="<%=path %>/content/images/admin/news-title-bg.gif"></TD>
                            <TD width="91%" background="<%=path %>/content/images/admin/news-title-bg.gif" class="left_ts">《》程序说明：</TD>
                            <TD width="5%" background="<%=path %>/content/images/admin/news-title-bg.gif" class="left_txt">&nbsp;</TD>
                          </TR>
                          <TR>
                            <TD bgcolor="#FAFBFC">&nbsp;</TD>
        ...
        <td valign="top"><table width="100%" height="144" border="0" cellpadding="0" cellspacing="0" class="line_table">
          <tr>
            <td width="7%" height="27" background="<%=path %>/content/images/admin/news-title-bg.gif"><img src="<%=path %>/content/images/admin/news-title-bg.gif" width="2" height="27"></td>
            <td width="93%" background="<%=path %>/content/images/admin/news-title-bg.gif" class="left_bt2">程序说明</td>
          </tr>
          <tr>
            <td height="102" valign="top">&nbsp;</td>
